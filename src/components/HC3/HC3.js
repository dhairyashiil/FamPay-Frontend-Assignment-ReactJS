...
export class HC3 extends Component {
    render() {
        ...
        let { Name, title, description, Cta, aspeeeectRatio, bgColor, imageUrl, Url1, text1, text2, ColorTitle, descriptionText1, descriptionText2, ColorDescription } = this.props;
